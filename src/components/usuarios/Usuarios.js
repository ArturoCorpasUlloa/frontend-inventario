...
import {obtenerUsuarios,crearUsuarios, actualizaUsuarioID, eliminarUsuarioID} from '../../services/UsuariosService'
...
export default function Estados() {
  ...
  const guardarEstado = async () => {
    ...
    setLoading(true)
    try{
      const res = await crearUsuarios(estado)
      console.log(res)
      setLoading(true)
      setEstado({nombre: ''})
      listEstados()
  ...
  const borrarEstado = async (e) => {
    ...
    try{
      ...
      console.log(id)
      const res = await eliminarUsuarioID(id)
      console.log(res)
      listEstados();
      setLoading(false)
    }catch(e){
  ...
  const editarMarca = async (e) => {
    ...
    try{
      setError(false)
      const resp = await actualizaUsuarioID(estado._id, estado);
      console.log(resp)
      resetEstado()
      listEstados()
    }catch(e){
