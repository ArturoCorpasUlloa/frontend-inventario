...
import {obtenerEstados,crearEstado,actualizaEstadoporID,eliminarEstadoID} from '../../services/EstadoService'
...
export default function Estados() {
  ...
  const borrarEstado = async (e) => {
    ...
    try{
      ...
      console.log(id)
      const res = await eliminarEstadoID(id)
      console.log(res)
      listEstados();
      setLoading(false)
    }catch(e){
  ...
  const editarEstado = async (e) => {
    ...
    try{
      setError(false)
      const resp = await actualizaEstadoporID(estado._id, estado);
      console.log(resp)
      resetEstado()
      listEstados()
    }catch(e){
