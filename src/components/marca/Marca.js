...
import {obtenerMarcas,crearMarca,actualizaMarcaID,eliminarMarcaID} from '../../services/MarcaService'
...
export default function Estados() {
  ...
  const borrarEstado = async (e) => {
    ...
    try{
      ...
      console.log(id)
      const res = await eliminarMarcaID(id)
      console.log(res)
      listEstados();
      setLoading(false)
    }catch(e){
  ...
  const editarMarca = async (e) => {
    ...
    try{
      setError(false)
      const resp = await actualizaMarcaID(estado._id, estado);
      console.log(resp)
      resetEstado()
      listEstados()
    }catch(e){
